...
- **Nix Tree Awareness:** Always run `git add .` or track new files before attempting a Nix evaluation or running a rebuild script, otherwise the Nix flake evaluator will silently ignore them.
