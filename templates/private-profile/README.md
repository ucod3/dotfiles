...
The framework's `docs/PRIVATE_PROFILE_BACKUP.md` guide explains the
provider-neutral workflow: scan first, create an empty private remote, push the
reviewed commit, verify the upstream commit, and rehearse restore without
activation.
